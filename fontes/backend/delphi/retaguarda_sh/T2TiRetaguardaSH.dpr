...
uses
  ...
  ObjetoAlexaRequest in 'Model\Transiente\ObjetoAlexaRequest.pas',
  ObjetoAlexaResponse in 'Model\Transiente\ObjetoAlexaResponse.pas',
  EmpresaModel in 'Model\Cadastros\EmpresaModel.pas',
  AdmModuloModel in 'Model\Cadastros\AdmModuloModel.pas',
  ErpTipoPlanoModel in 'Model\Cadastros\ErpTipoPlanoModel.pas',
  ErpTipoPlanoController in 'Controller\Cadastros\ErpTipoPlanoController.pas',
  ErpTipoPlanoService in 'Service\Cadastros\ErpTipoPlanoService.pas';
