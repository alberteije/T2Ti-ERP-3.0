...
uses
  System.SysUtils, UDataModuleConexao, UDataModule, MVCFramework.Serializer.Commons,
...
type
  ...
  public
    ...
    class function ExecutarConsulta(AConsulta: string): Integer;
  end;
...
class function TServiceBase.ExecutarConsulta(AConsulta: string): Integer;
var
  ConsultaSQL, FiltroSQL: string;
begin
  try
