...
begin
  try
    ...
    Lista60M := TListaEcfSintegra60mVO(TT2TiORM.ConsultarLista(TEcfSintegra60mVO.Create, 'DATA_EMISSAO BETWEEN ' + QuotedStr(DataInicial) + ' and ' + QuotedStr(DataFinal)));
    ...
    begin
      ...
      begin
        ...
        try
          ...
          Lista60A := TListaEcfSintegra60aVO(TT2TiORM.ConsultarLista(TEcfSintegra60aVO.Create, 'ID_SINTEGRA_60M = ' + IntToStr(TEcfSintegra60mVO(Lista60M.Items[i]).Id)));
    ...
    Lista60D := TListaViewSintegra60dVO(TT2TiORM.ConsultarLista(TViewSintegra60dVO.Create, 'DATA_EMISSAO BETWEEN ' + QuotedStr(DataInicial) + ' and ' + QuotedStr(DataFinal)));
    if Assigned(Lista60D) then
    begin
      ...
      begin
        ...
        // REGISTRO TIPO 75 - CÓDIGO DE PRODUTO OU SERVIÇO
        Produto := TProdutoVO(TT2TiORM.ConsultarUmObjeto(TProdutoVO.Create, 'GTIN=' + QuotedStr(Registro60D.Codigo)));
    ...
    Lista60R := TListaViewSintegra60rVO(TT2TiORM.ConsultarLista(TViewSintegra60rVO.Create, 'DATA_EMISSAO BETWEEN ' + QuotedStr(DataInicial) + ' and ' + QuotedStr(DataFinal)));
    if Assigned(Lista60R) then
    begin
      ...
      begin
        ...
        // REGISTRO TIPO 75 - CÓDIGO DE PRODUTO OU SERVIÇO
        Produto := TProdutoVO(TT2TiORM.ConsultarUmObjeto(TProdutoVO.Create, 'GTIN=' + QuotedStr(Registro60R.Codigo)));
        if Assigned(Produto) then
        begin
          Registro75 := TRegistro75.Create;
          Registro75.DataInicial := FDataModule.ACBrSintegra.Registro10.DataInicial;
...
begin
  try
    ...
    //Lista61R := TListaViewSintegra61rVO(TT2TiORM.ConsultarLista(TViewSintegra61rVO.Create, 'DATA_EMISSAO BETWEEN ' + QuotedStr(DataInicial) + ' and ' + QuotedStr(DataFinal)));
    ...
    //
    //    // REGISTRO TIPO 75 - CÓDIGO DE PRODUTO OU SERVIÇO
    //    Produto := TProdutoVO(TT2TiORM.ConsultarUmObjeto(TProdutoVO.Create, 'GTIN=' + QuotedStr(Registro61R.Codigo)));
    //    if Assigned(Produto) then
    //    begin
    //      Registro75 := TRegistro75.Create;
    //      Registro75.DataInicial := FDataModule.ACBrSintegra.Registro10.DataInicial;
