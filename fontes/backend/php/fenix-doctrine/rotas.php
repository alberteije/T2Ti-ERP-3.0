...
// banco
$app->get('/banco[/]', \BancoController::class . CONSULTAR_LISTA)->add($auth);
$app->get('/banco/{id}', \BancoController::class . CONSULTAR_OBJETO)->add($auth);
$app->post('/banco', \BancoController::class . INSERIR)->add($auth);
$app->put('/banco/{id}', \BancoController::class . ALTERAR)->add($auth);
$app->delete('/banco/{id}', \BancoController::class . EXCLUIR)->add($auth);
