...
export class NodeService {
    ...
    tratarRelacionamentos(relacionamentos: ComentarioDerJsonModel[]) {
        ...
        if (this.usarQueryRunner) {
            // import
            this.imports.push("import { DataSource, QueryRunner } from 'typeorm';")
            ...
            this.metodoPersistir.push("  const queryRunner = this.dataSource.createQueryRunner();");
            this.metodoPersistir.push("");
            ...
            this.metodoExcluirMestre.push("  const queryRunner = this.dataSource.createQueryRunner();");
