...
export class FlutterListaPageBase {
    ...
    definirDataColumn(viewDB: boolean) {
        ...
        this.dataColumn.push("    sort<" + this.campoModel.tipoDadoOrdenacao + ">((" + this.class + " " + this.objetoPrincipal + ") => " + this.objetoPrincipal + "." + this.campoModel.nomeCampoAtributo + ", columnIndex, ascending),");
    ...
    definirDataCell(viewDB: boolean, abaDetalhe: boolean, gerandoParaOMoor = false) {
        if (this.objetoJsonComentario?.tipoControle?.mascara != null
                ...
                && this.objetoJsonComentario?.tipoControle?.mascara != 'dd/MM/yyyy'
            ...
            if (this.campoModel.tipoDadoOrdenacao == 'num' && !this.campoModel.tipoCampo.includes("int")) {
                ...
                this.dataCell.push("DataCell(Text(" + this.objetoPrincipal + "." + this.campoModel.nomeCampoAtributo + "?.toString() ?? ''), onTap: () {");
            } else if (this.campoModel.tipoDadoOrdenacao == 'DateTime') {
                this.dataCell.push("DataCell(Text(Biblioteca.formatarData(" + this.objetoPrincipal + "." + this.campoModel.nomeCampoAtributo + ")), onTap: () {");
            } else {
