...
export class FlutterAbaMestrePersistePageOneToOne extends FlutterPersistePageBase {
    ...
    montarCampoComLookup() {
        ...
        if (this.campoModel.nomeCampoTabela.includes('ID_')) {
            ...
            this.inputLookup.push("                    widget." + this.objetoMestre + "!." + this.objetoPrincipal + "?." + this.objetoJsonComentario.objetoMestre + " = " + this.objetoJsonComentario.classeMestre + ".fromJson(objetoJsonRetorno);");
        } else { // se é um campo de lookup para simples consulta, não precisa vincular ao objeto mestre, pois o dado será persistido no campo da própria tabela
    ...
    montarTextFormFieldPadrao() {
        ...
        if (this.objetoJsonComentario.tipoControle.mascara != '' && this.objetoJsonComentario.tipoControle.mascara != null) {
            ...
            if (this.campoModel.tipoCampo.includes('decimal')) {
                ...
                this.inputController.push("final " + this.campoModel.nomeCampoAtributo + "Controller = MoneyMaskedTextController(precision: Constantes." + casasDecimais + ", initialValue: widget." + this.objetoMestre + "!." + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " ?? 0);");
            } else {
        ...
        if (this.campoModel.tipoCampo.includes('decimal')) {
            this.inputNormal.push(this.completaEspacosFilhoPadding + "          widget." + this.objetoMestre + "!." + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " = " + this.campoModel.nomeCampoAtributo + "Controller.numberValue;");
